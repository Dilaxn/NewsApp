                                                                ...
                                                                <View style={{
                                                                    ...
                                                                    <Text style={{
                                                                        ...
                                                                        <Text style={{
                                                                            ...
                                                                            border: '3px red',
                                                                            borderWidth: 2,
                                                                        }}>{props.route.params.category}</Text>
                                                                    </Text>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <View style={{
                                                                ...
                                                                <Text
                                                                    style={{fontFamily: "Times New Roman",}}>Channel</Text>
                                                                <Text numberOfLines={2} style={{
                                                                    paddingTop: 5,
                                                                    fontWeight: 'bold'
                                                                }}>{news.title}</Text>
                                                                <Text numberOfLines={3}
                                                                      style={{paddingTop: 5, fontWeight: '300'}}>An
                                                                    enthusiastic, self-motivated, responsible and
                                                                    hardworking
                                                                    undergraduate student with excellent communication
                                                                    skills,
                                                                    willing to take-up new challenges and work in a
                                                                    challenging
                                                                    environment.</Text>
